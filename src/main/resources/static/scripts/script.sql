...
INSERT INTO UNIDAD_MEDIDA(ID, NOMBRE, ESTADO) VALUES (SEQ_ARTICULO.nextval, 'UND', 1);
INSERT INTO UNIDAD_MEDIDA(ID, NOMBRE, ESTADO) VALUES (SEQ_ARTICULO.nextval, 'KRG', 1);

-- CONTRASENA: admin
INSERT INTO USUARIO(ID, NOMBRES, APELLIDOS, USUARIO, CONTRASENA, ESTADO) VALUES (SEQ_USUARIO.nextval, 'MARCO', 'LOPEZ', 'ADMIN', '$2a$10$RwRa4vMjwf3LhU7UaFSbnethimInmV7Bshux7A3YdfGFfa2mgWvKa', 1);

INSERT INTO ROL(ID, NOMBRE, ESTADO) VALUES (SEQ_ROL.nextval, 'ADMIN', 1);
INSERT INTO ROL(ID, NOMBRE, ESTADO) VALUES (SEQ_ROL.nextval, 'VENTA', 1);
INSERT INTO ROL(ID, NOMBRE, ESTADO) VALUES (SEQ_ROL.nextval, 'FACTURACION', 1);
